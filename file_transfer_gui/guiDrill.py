...
def load_gui(self):
    ...
    #Buttons
    self.btn_browse1 = tk.Button(self.master, width = 12, height = 1, text = "Browse...",command = lambda: guiDrill_func.askDir(self))
    self.btn_browse1.grid(row = 1,column = 1,padx=(30,20),pady = (5,5))
    self.btn_browse2 = tk.Button(self.master, width = 12, height = 1, text = "Browse...",command = lambda: guiDrill_func.askDir2(self))
    self.btn_browse2.grid(row = 2,column = 1,padx=(30,20),pady = (5,5))
    self.btn_Chk4files = tk.Button(self.master, width = 12, height = 2, text = "Check for files...", command = lambda: guiDrill_func.chk4Files(self))
